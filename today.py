...
if __name__ == '__main__':
    ...
    # TODO: set your own birthday here -> datetime.datetime(YEAR, MONTH, DAY)
    age_data, age_time = perf_counter(daily_readme, datetime.datetime(2007, 8, 10))
    ...
    # NOTE: the original author added stats from deleted repos via cache/repository_archive.txt.
    # Not needed for a fresh account, so that block is removed.
