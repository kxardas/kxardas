...
Зараз ліворуч — dev-дужки `</>`, згенеровані `brackets.py` (44×25 символів).
Щоб змінити — відредагуй `brackets.py` і онови рядки в блоці `<text x="15" ...>` обох SVG
(або дай мені — перегенерую під іншу іконку).
